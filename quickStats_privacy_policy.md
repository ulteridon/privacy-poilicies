...
**Permissions Used:**
- `READ_MEDIA_IMAGES` / `READ_MEDIA_VIDEO` / `READ_MEDIA_AUDIO` (Android 13+) – To let you select photos and media to use in templates
- `READ_MEDIA_VISUAL_USER_SELECTED` (Android 14+) – To access only the photos you explicitly select
- `READ_EXTERNAL_STORAGE` / `WRITE_EXTERNAL_STORAGE` (Android 12 and below) – To read media and save created images
- `ACCESS_MEDIA_LOCATION` – Only if required to preserve image metadata when you choose to include it
- `RECORD_AUDIO` – Used only if you opt into features that require audio capture; audio is processed locally and never transmitted
...
- You may optionally select a profile picture from your device's gallery
- The selected image is stored **locally on your device** only and is never transmitted to our servers
...
- **Solely for app functionality** – letting you pick photos, compose them into templates, and save the result to your device
...
**We do NOT sell, trade, or transfer your photos, media, or personal information to third parties.**
...
- Third-party apps handle shared content under their own privacy policies
...
- Your photos and created images remain on your device
...
- **Google Play** (Android): [Google Privacy Policy](https://policies.google.com/privacy)
- **Apple App Store** (iOS): [Apple Privacy Policy](https://www.apple.com/privacy/)

App store platforms may collect diagnostic and purchase data under their own policies.
...
✅ **All image creation happens locally**
